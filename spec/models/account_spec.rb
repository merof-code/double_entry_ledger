...
RSpec.describe Ledger::Account, type: :model do
  ...
  #   it {
  #     expect(subject).to have_many(:person_account_balances).class_name("Ledger::PersonAccountBalance").with_foreign_key("ledger_account_id").inverse_of(:ledger_account)
  #   }

  #   it {
  #     expect(subject).to have_many(:entries).class_name("Ledger::Entry").with_foreign_key("ledger_account_id").inverse_of(:ledger_account)
  #   }
  # end
  ...
  # describe "enum" do
  #   it {
  #     expect(subject).to define_enum_for(:account_type).with_values(%i[equity liability revenue expense
  #                                                                      asset]).with_prefix(:account)
  #   }
  # end
